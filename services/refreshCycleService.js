...
const { callNewsAPI } = require("./apiNewsCaller.js");
...
function getTimeBeforeStartCycle() {
    ...
    // 
    var now = new Date().set({ hour: 23, minute: 58, second: 17 });
...
async function startCycle(userData, interval, socket) {
    await setTimeout(() => {
...
module.exports = { getTimeBeforeStartCycle, getTimeCycle, startCycle };